...
## 2026-05-27 -- Midday Addendum (Day 20, Wednesday)
- **XOM STOPPED OUT at the open.** Trailing stop ($147.31, hwm $163.68) triggered on the Iran/Hormuz crude-unwind gap-down; 131 sh filled @ $146.42 (09:33 ET), realized **-$734.91 (-3.69%)** vs $152.03 entry. The May 25 primary risk -- Hormuz supply-premium deflation -- played out. XOM = energy **failed trade #1 of 2** (sector-exit rule).
- **XLE held.** -1.94% unrealized ($57.33), intraday -0.91% -- the diversified ETF is absorbing the crude move far better than the XOM single-name. Above the -7% manual cut ($54.37, +5.5% buffer) and above its armed trail $55.53 (3.1% below). No cut, no tighten, no stop move. Not pre-empting a name that's above every trigger.
- **Thesis status: cracking, not dead.** Energy leadership challenged by the geopolitical-bid unwind, but XLE's relative strength keeps the door open. Decision: HOLD XLE on heightened alert. If XLE breaches $54.37 -> manual cut (= failed trade #2 -> exit energy). No new entries -- powder preserved (cash 80.3%, deployment 19.7%) through today's XOM redomicile vote and Thu's Core PCE; reassess rotation to XLB/XLI post-PCE if energy rolls further. Patience > activity.
