...
### May 26 -- EOD Snapshot (Day 19, Tuesday)
**Portfolio:** $99,490.72 | **Cash:** $60,207.62 (60.5%) | **Day P&L:** -$1,229.89 (-1.22%) | **Phase P&L:** -$509.28 (-0.51%)

| Ticker | Shares | Entry | Close | Day Chg | Unrealized P&L | Stop |
|--------|--------|-------|-------|---------|----------------|------|
| XLE | 340 | $58.46 | $57.86 | -2.74% | -$204.05 (-1.03%) | $55.53 (10% trail, hwm $61.70) |
| XOM | 131 | $152.03 | $149.70 | -3.37% | -$305.23 (-1.53%) | $147.31 (10% trail, hwm $163.68) |

**Notes:** Energy resumes the slide after Friday's stabilization (post-Memorial Day holiday Mon May 25 closed). XOM -3.37% to $149.70 led the decline, breaking back under its $152.03 entry for the first time; XLE -2.74% to $57.86, also slipping below its $58.46 entry. Both positions flip to negative unrealized for the first time in the campaign (XLE -1.03%, XOM -1.53%). Day P&L -$1,229.89 (-1.22%) -- second -1%+ day in a week, matching the May 20 magnitude. Phase rolls red to -$509.28 (-0.51%), giving back the entire week-3 gain and the May 19 +$2,330 hwm. Both names still well clear of the -7% manual cut (XLE 6.4% above $54.37, XOM 5.9% above $141.39) and stops unchanged at $55.53 / $147.31 (no fresh hwm; XLE needs $61.70+, XOM $163.68+ to ratchet -- now 6.6% and 9.3% away). Both stops remain net-positive vs entry -- worst-case outcome on these positions is still a small locked-in gain. No trades, weekly count 0/3 (Mon holiday), deployment 39.5%. Two pullback legs (May 20-22 fade, then today) have erased the breakout; thesis now on watch -- a close back under entry on both names is the first crack. Tomorrow: pre-market read on WTI/energy -- if names stabilize or bounce back above entries, hold and let trail work; if continuation lower, monitor the -7% cut levels ($54.37 XLE / $141.39 XOM) and let GTC trails protect; no new entries until energy reclaims structure or fresh sector leadership confirms. 3 weekly trades available, 3 open slots.
