...
### Jun 05 -- EOD Snapshot (Day 27, Friday)
**Portfolio:** $97,338.80 | **Cash:** $13,711.12 (14.08%) | **Day P&L:** -$2,445.05 (-2.45%) | **Phase P&L:** -$2,661.20 (-2.66%)

| Ticker | Shares | Entry | Close | Day Chg | Unrealized P&L | Stop |
|--------|--------|-------|-------|---------|----------------|------|
| MTUM | 75 | $315.5848 | $306.80 | -5.85% | -$658.86 (-2.78%) | $298.34 (10% trail, hwm $331.49) |
| XLB | 363 | $51.18168 | $50.63 | -1.92% | -$200.26 (-1.08%) | $46.98 (10% trail, hwm $52.1999) |
| XLE | 340 | $58.460147 | $57.6341 | -1.90% | -$280.86 (-1.41%) | $55.53 (10% trail, hwm $61.70) |
| XLI | 130 | $171.67 | $174.18 | -1.12% | +$326.30 (+1.46%) | $158.80 (10% trail, hwm $176.44) |

**Notes:** Post-NFP risk-off across the board -- worst day of the campaign. MTUM took the brunt (-5.85% to $306.80, unrealized swung from +$771 yest to -$659 today -- a -$1,430 intraday hit), confirming momentum-factor unwind on the print. XLB -1.92% to $50.63 (unrealized flipped +$185 -> -$200), XLE -1.90% to $57.6341 (unrealized +$92 -> -$281), XLI -1.12% to $174.18 (still the only green name, +$326 vs +$584 yest). Day P&L -$2,445 (-2.45%); phase widens from -$216 to -$2,661 (-2.66%) -- new campaign low, worse than the prior 5/29 low of -$1,466. Deployment 85.92% ($83,628 / $97,339), still just above the 85% floor though long_market_value contraction is the only thing keeping the ratio in line. Sector mix: Energy 20.1% / Materials 18.9% / Industrials 23.3% / Multi-sector momentum 23.6% / Tech 0% -- compliant. MTUM stop now $298.34 = 2.76% below close $306.80 -- inside the 3% buffer rule, but trail was set legitimately on hwm $331.49 and the rule prohibits MOVING a stop closer, not the natural compression of an existing trail as price falls; stop unchanged, sized to fire if MTUM keeps bleeding. No -7% manual cuts (worst MTUM -2.78%). No +15% trail-tighten eligible. No new entries -- correct call yesterday to reserve, not chase, into NFP; weekly closes 5/6 new entries + 1 stop-out exit, 1 slot unused. Weekly review session this afternoon. Monday: pre-market read on whether NFP was a one-day shock or trend break; MTUM is the canary -- if it loses $298.34 trail Monday, momentum unwind confirmed and remaining book gets re-assessed; XLB/XLE/XLI all have ~7-9% trail buffer remaining; if no further damage, hold and let trails work; if any name -> stop, accept and rotate to a fresh sector leader from SANM/LYB/GNRC/SNDK/TPL with 6 fresh weekly slots next week. 6 weekly trades available, 4 open slots.
