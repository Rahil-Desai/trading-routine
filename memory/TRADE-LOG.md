...
### May 27 -- Midday Scan (Day 20, Wednesday)
**Portfolio:** $98,884.27 | **Cash:** $79,388.64 (80.3%) | **Day P&L:** -$617.46 (-0.62%) | **Phase P&L:** -$1,115.73 (-1.12%)

**EXIT -- XOM trailing stop triggered at the open.** 131 sh sold @ $146.42 (09:33 ET), trail $147.31 (hwm $163.68) hit on the Hormuz-premium / crude-crash gap-down, filled with slippage below the trigger. Realized **-$734.91 (-3.69%)** vs $152.03 entry -- first realized exit of the campaign. Trail order auto-closed (no separate cancel needed). XOM = energy **failed trade #1 of 2** for the sector-exit rule.

| Ticker | Shares | Entry | Current | Day Chg | Unrealized P&L | Stop |
|--------|--------|-------|---------|---------|----------------|------|
| XLE | 340 | $58.46 | $57.33 | -0.91% | -$385.95 (-1.94%) | $55.53 (10% trail, hwm $61.70) |

**Notes:** XOM stopped out at today's open on the Iran/Hormuz crude unwind -- the exact thesis pillar (supply-risk premium) deflating, as flagged in the May 25 pre-market. Realized -$735; the 10% trail did its job vs the $163.68 hwm but locked a loss vs entry. XLE is the lone position now: -1.94% unrealized, intraday -0.91%, well clear of the -7% manual cut ($54.37, 5.5% buffer) and above its armed trail $55.53 (3.1% below current -- outside the 3% rule, left unchanged, no fresh hwm). No -7% cut, no tighten, no stop move today. Deployment collapses to 19.7% (cash 80.3%); phase flips red -$1,116 (-1.12%). Energy thesis cracking but not dead -- XLE (diversified ETF) holding far better than XOM single-name, so HOLD on heightened alert rather than pre-empt a name above all triggers. Weekly new-trade count 0/3, 1 open slot used. Rest of day: if XLE breaches $54.37 -> manual cut without hesitation (would be failed trade #2 = exit energy); if it stabilizes, let the trail work. No new entries -- preserve powder through the XOM redomicile vote (today) and Core PCE (Thu May 28); reassess sector rotation (XLB/XLI) post-PCE if energy rolls. Patience > activity.
