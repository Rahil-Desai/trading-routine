...
### Jun 10 -- EOD Snapshot (Day 30, Wednesday)
**Portfolio:** $96,459.16 | **Cash:** $13,711.12 (14.21%) | **Day P&L:** -$1,388.50 (-1.42%) | **Phase P&L:** -$3,540.84 (-3.54%)

| Ticker | Shares | Entry | Close | Day Chg | Unrealized P&L | Stop |
|--------|--------|-------|-------|---------|----------------|------|
| MTUM | 75 | $315.5848 | $304.92 | -2.15% | -$799.86 (-3.38%) | $298.34 (10% trail, hwm $331.49) |
| XLB | 363 | $51.18168 | $49.58 | -2.34% | -$581.41 (-3.13%) | $46.98 (10% trail, hwm $52.1999) |
| XLE | 340 | $58.46 | $58.33 | +1.64% | -$44.25 (-0.22%) | $55.53 (10% trail, hwm $61.70) |
| XLI | 130 | $171.67 | $169.61 | -3.41% | -$267.80 (-1.20%) | $158.92 (10% trail, hwm $176.58) |

**Notes:** Risk-off CPI session -- print hotter than expected (consensus) -- broad tape down with rates higher; only XLE held green on WTI bid. Day P&L -$1,389 (-1.42%), worst single-day drawdown since Fri Jun 05 NFP. Phase widens to fresh campaign low -$3,541 (-3.54%). XLI hit hardest (-3.41% to $169.61, industrials sold off on capex worries, unrealized flipped +2.24% -> -1.20%, hwm $176.58 unchanged, 6.7% above $158.92 trail); MTUM -2.15% to $304.92 (broke through entry $315.58 hard, unrealized -3.38%, 2.2% above $298.34 trail -- tightest cushion in the book, only $11.43 above -7% manual cut at $293.49); XLB -2.34% to $49.58 (Materials gave back Tue's recovery and broke $50 handle, unrealized -3.13%, 5.5% above $46.98 trail). Lone bright spot: XLE +1.64% to $58.33 (energy decoupled, oil bid on geopolitical premium, unrealized recovers to -0.22%). No fresh hwm anywhere -> no trail ratchets. Deployment 85.79% ($82,748 long_market_value / $96,459 equity), down 0.2pp but still 0.79pp above 85% floor -- buffer is paper-thin. Sector mix: Energy 20.6% / Materials 18.7% / Industrials 22.9% / Multi-sector momentum 23.7% / Tech 0% -- all under 25% per-position and 30% sector caps. No -7% manual cuts triggered (worst MTUM -3.38%, 3.62pp from threshold). No +15% trail tightens. No trades today, weekly count 0/6. Watchlist (LYB/GNRC/TPL/SANM/SNDK) all likely sold off in sympathy -- no fresh entry signal on a broad-down session. Tomorrow (Thu, FOMC Jun 18 in 8 days, PPI Thu): pre-market read on CPI hangover vs PPI -- if risk-on relief bounce and MTUM holds $300, hold and let trails work; if MTUM breaches $298.34 trail -- stop fires automatically and frees ~$23K to redeploy (would drop deployment to ~62%, mandatory redeploy same day); if any position hits -7% manual cut (MTUM closest at $293.49), exit without hesitation; do NOT chase fresh entries into a Fed-week tape -- defense over offense; 6 weekly trades available, 4 open slots, but bias is patience until post-FOMC clarity.
