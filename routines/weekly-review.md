...
Portfolio: \$X (X% week, X% phase) vs S&P 500: X%
...
If TRADING-STRATEGY.md didn't change, add just WEEKLY-REVIEW.md. On push failure: git pull --rebase origin main, then push again. Never force-push.
